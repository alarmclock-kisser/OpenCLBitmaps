...
namespace OpenCLBitmaps
{
    public class ImageHandling
    {
        ...
        // ----- ----- CONSTRUCTOR ----- ----- \\
        public ImageHandling(string repopath, ListBox imageslistbox, PictureBox viewpicturebox, NumericUpDown zoomNumeric, Label metalabel)
        {
            // Set attributes
        ...
        public void CenterImage()
        {
            ...
            if (this.CurrentImage != null)
            {
                // Set zoom to 100% if CTRL is down.
                if ((Control.ModifierKeys & Keys.Control) != 0)
                {
                    this.zoomFactor = 1.0f;
                    this.ZoomNumeric.Value = 100;
                    this.ApplyZoom();
                }
